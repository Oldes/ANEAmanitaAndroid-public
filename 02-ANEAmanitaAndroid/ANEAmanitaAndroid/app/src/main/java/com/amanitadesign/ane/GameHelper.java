...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    public final static int CLIENT_ALL = CLIENT_GAMES | CLIENT_SNAPSHOT; /* CLIENT_PLUS | CLIENT_APPSTATE |*/
    ...
    */
    ...
    public GoogleApiClient.Builder createApiClientBuilder() {
        debugLog("[createApiClientBuilder] mSetupDone: "+mSetupDone+" mRequestedClients: "+mRequestedClients);
        if (mSetupDone) {
        ...
        builder = new GoogleApiClient.Builder(mActivity, this, this);

        if (0 != (mRequestedClients & CLIENT_GAMES)) {
            debugLog("[createApiClientBuilder] Games API");
            builder.addApi(Games.API, mGamesApiOptions);
            builder.addScope(Games.SCOPE_GAMES);
        }
        if (0 != (mRequestedClients & CLIENT_SNAPSHOT)) {
            debugLog("[createApiClientBuilder] Drive API");
